...
class OrderUpdate(BaseModel):
    ...
    """
    total_price: Optional[float] = Field(None, gt=0, description="Updated total price of the order")
...
class Order(OrderBase):
    ...
    updated_at: Optional[datetime] = Field(None, description="The timestamp when the order was last updated")
